...
;In the final version of the code some of the macros and some of the subroutines
; build upon the code of the earlier versions.
;This file uploaded on 18/3/2020
...
;---------------------------------------------------
       ...
       macro Loadsprite,thesprnum , thesprcol , B1 , B2 , B3 , B4 , B5 , B6 , B7 , B8  , SPRITEHEIGHT , SPRITEINITACROSSUNIT , SPRITE1NUM , SPRITE1COL , SPRITEBASE , SPRITE1X , SPRITE1Y  
 	ld hl,\SPRITEBASE;
 	ld a,\B1; 1st byte
 	call Vpoke;
 	inc hl;2nd byte
...
P1score: db 'P1 Score',255	;255 defines end of a string
P2score: db 'P2 Score',255	;
;------------------------------------------------------
